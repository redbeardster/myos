...
run: $(BUILD)/myos.iso
	qemu-system-x86_64 -M q35 -m 256M -smp 8 -cdrom $(BUILD)/myos.iso -boot d

run-serial: $(BUILD)/myos.iso
	qemu-system-x86_64 -M q35 -m 256M -smp 8 -cdrom $(BUILD)/myos.iso -boot d -serial stdio -display none
